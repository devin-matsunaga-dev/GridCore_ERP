...
namespace GridCore.Modules.Customers.Data.Migrations
{
    ...
    [Migration("20260827001459_WP220_PaymentArrangements")]
    partial class WP220_PaymentArrangements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GridCore.Modules.Customers.Features.Arrangements.ArrangementInstalment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_arrangement_instalments");

                    b.HasIndex("DueDate")
                        .HasDatabaseName("ix_arrangement_instalments_due_date");

                    b.HasIndex("PaymentArrangementId", "Sequence")
                        .IsUnique()
                        .HasDatabaseName("ux_arrangement_instalments_arrangement_sequence");

                    b.ToTable("arrangement_instalments", "customers");
                });

            modelBuilder.Entity("GridCore.Modules.Customers.Features.Arrangements.ArrangementLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<int>("MaximumInstalments")
                        .HasColumnType("integer")
                        .HasColumnName("maximum_instalments");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_arrangement_limits");

                    b.HasIndex("CustomerClass")
                        .IsUnique()
                        .HasDatabaseName("ux_arrangement_limits_customer_class");

                    b.ToTable("arrangement_limits", "customers");

                    b.HasData(
                        new
                        {
                            Id = new Guid("01a04317-5e00-7b13-b0b4-4a028a08b4e8"),
                            Currency = "USD",
                            CustomerClass = "Residential",
                            MaximumBalance = 1500.00m,
                            MaximumInstalments = 6,
                            Notes = "Demo figures. CUC publishes that Customer Service will arrange payment rather than disconnect, and does not publish what a representative may agree without a supervisor; these ceilings are GridCore's own and are not an authoritative delegation."
                        },
                        new
                        {
                            Id = new Guid("01a04317-5e00-7a7d-8b76-34355f44b9d8"),
                            Currency = "USD",
                            CustomerClass = "Commercial",
                            MaximumBalance = 5000.00m,
                            MaximumInstalments = 12,
                            Notes = "Demo figures, set higher than the residential ceiling because a commercial arrears of several thousand dollars over a year is ordinary. Not an authoritative delegation."
                        });
                });

            modelBuilder.Entity("GridCore.Modules.Customers.Features.Arrangements.PaymentArrangement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateOnly>("ArrangedOn")
                        .HasColumnType("date")
                        .HasColumnName("arranged_on");
                    ...
                    b.Property<decimal>("ArrearsBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                    ...
                    b.Property<int>("InstalmentCount")
                        .HasColumnType("integer")
                        .HasColumnName("instalment_count");

                    b.Property<int>("IntervalDays")
                        .HasColumnType("integer")
                        .HasColumnName("interval_days");

                    b.Property<decimal>("LimitMaximumBalance")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("limit_maximum_balance");

                    b.Property<int>("LimitMaximumInstalments")
                        .HasColumnType("integer")
                        .HasColumnName("limit_maximum_instalments");
                    ...
                    b.ToTable("payment_arrangements", "customers");
                });
            ...
            modelBuilder.Entity("GridCore.Modules.Customers.Features.Arrangements.ArrangementInstalment", b =>
                {
                    b.HasOne("GridCore.Modules.Customers.Features.Arrangements.PaymentArrangement", null)
