...
/// <summary>
/// The generator underneath the simulator. Its own tests because "the same seed gives the same
/// numbers" is the property everything above depends on, and <see cref="Random"/> is not documented
/// to give it.
/// </summary>
